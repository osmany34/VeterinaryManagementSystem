...
public class ResultHelper {
    ...
    public static <T> ResultData<T> validateError(List<String> errorMessages) {
        return (ResultData<T>) new ResultData<>(false, Messages.VALIDATE_ERROR, "400", errorMessages);
    }
